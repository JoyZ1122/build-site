...
let devServer = {
  proxy: {
    // 代理
    '/': {
      // target: 'http://39.98.241.29:4000', //设置你调用的接口域名和端口号 别忘了加http
      // target: ' http://192.168.21.163:4000', //设置你调用的接口域名和端口号 别忘了加http
      target: ' http://192.168.8.64:4000', //设置你调用的接口域名和端口号 别忘了加http
      ws: false,

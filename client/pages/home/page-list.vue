    ...
    <div class="page-content">
      ...
      <ul class="page-item-wrapper">
        ...
        <li class="page-item" v-for="(item, index) in pageList" :key="index">
          ...
          <span class="publish" v-if="item.isPublish">已发布</span>
          ...
          <div class="page-item-title border-T">
            ...
            <span class="item-count">访问量：{{item.viewsCount || 0}}</span>
          </div>
...
export default {
  ...
  data() {
    return {
      loading: false,
      defaultCoverImage: require("@client/common/images/fengmian.png"),
      pageList: [],
      myCount: 0,
      shareCount: 0,
      previewId: "",
  ...
  methods: {
    ...
    showPreviewFn(id) {
      sessionStorage.setItem("iseditFlag", 2);
      this.previewId = id;
      this.showPreview = true;
    },
    /**
